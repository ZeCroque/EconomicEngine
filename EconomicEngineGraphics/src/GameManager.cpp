...
GameManager::GameManager() : window(std::make_unique<sf::RenderWindow>(sf::VideoMode(800, 600), "g_windowTitle")), hasEverRun(false), isInitialized(false), isRunning(false), isGuiOpened(false)
{
