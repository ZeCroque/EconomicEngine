...
ToolBehavior::ToolBehavior(const float inCraftRateBoost, const float inDegradationRate) : craftRateBoost(inCraftRateBoost), degradationRate(inDegradationRate), durability(1.0f){}
